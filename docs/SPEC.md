...
- [ ] **操作系 audit kind (§10.2.2.1 の 24 種: resume / resumed / lock_seized / init_rollback / init_rollback_failed / retry_resumed / runner_idle / audit_hmac_key_rotated / queue_corruption_recovered / sanitize_pass_hmac / auto_merge_disabled / auto_merge_reserved / branch_deleted / retry_pr_closed / effort_downgrade / phase_self_correct / phase_started / phase_completed / review_finding_seen / fix_started / fix_finished / review_started / phase_override_started / phase_override_ended) が info または指定 level で必ず記録**
