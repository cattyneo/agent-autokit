...
description: Use for Next.js / shadcn/ui implementation and fix phases.
---
...
## Rules
- Read the issue, plan, SSOT, routes, components, tests, and current diff before editing.
- Prefer established Next.js and shadcn/ui conventions over custom primitives.
- Use RED / GREEN / REFACTOR for UI behavior, accessibility, responsive layout, and data boundary changes when practical.
